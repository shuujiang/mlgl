<template>
	<div class="waitrelease innercontent">
		<div>
			<div class="formAction">
				...
				<div class="tableformitemTime">
					<span class="tableformitemlebel">入库时间：</span>
					<div  class="tableformitemInput">
			...
			<el-table :data="currentData" border style="width: 100%" @selection-change="handleSelectionChange">
				...
				<el-table-column label="操作" width="150">
					<template slot-scope="scope">
						...
						<el-button size="small" type="primary" @click="showDialog(5,scope.$index, scope.row)">发布</el-button>
					</template>
				</el-table-column>
			</el-table>
			<div class="paging">
