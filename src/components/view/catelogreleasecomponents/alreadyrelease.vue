<template>
	<div class="alreadyrelease innercontent">
		<div>
			<div class="formAction">
				...
				<div class="tableformitemTime">
					<span class="tableformitemlebel">发布时间：</span>
					<div  class="tableformitemInput">
			...
			<el-table :data="currentData" border @selection-change="handleSelectionChange">
				...
				<el-table-column label="操作" width="150">
					<template slot-scope="scope">
						<el-button size="small" type="primary" @click="showDialog(6,scope.$index, scope.row)">查看</el-button>
						<el-button size="small" type="primary" @click="showDialog(7,scope.$index, scope.row)">退回</el-button>
					</template>
				</el-table-column>
			</el-table>
			<div class="paging">
