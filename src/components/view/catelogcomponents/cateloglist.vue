	<template>
		<div class="cateloglist innercontent">
			<div>
				...
				<div class="formAction">
					...
					<div class="actionButtons">
						<el-button type="primary">自动导入</el-button>
					</div>
				</div>
				<el-table :data="currentData" border @selection-change="handleSelectionChange">
					...
					<el-table-column label="操作" width="290">
						<template slot-scope="scope">
							...
							<el-button size="small" type="primary" @click="handleSubmit(scope.$index, scope.row)">提交</el-button>
