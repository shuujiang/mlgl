<template>
	<div class="catelogstatistics innercontent">
		<div>
			...
			<el-table :data="currentData" border @selection-change="handleSelectionChange">
				...
				<el-table-column prop="dataItem.length" label="数据项量"></el-table-column>
				<el-table-column prop="browse" label="浏览人数"></el-table-column>
